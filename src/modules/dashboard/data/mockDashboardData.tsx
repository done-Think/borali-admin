...
export const recentRides: RecentRide[] = [
  ...
  },
  {
    ...
    passenger: 'Joao Lima',
    driver: 'Bianca Costa',
    route: 'Moema -> Congonhas',
    origin: 'Moema',
    destination: 'Aeroporto de Congonhas',
    value: 36.5,
    status: 'Concluida',
    duration: '19 min',
    requestedAt: 'ha 8 min',
    path: [[-23.6033, -46.6658], [-23.6142, -46.6611], [-23.6265, -46.6564], [-23.6269, -46.6566]],
    driverPosition: [-23.6269, -46.6566],
    passengerPosition: [-23.6269, -46.6566],
  },
  {
    id: 'BRL-84209',
    passenger: 'Ana Beatriz',
    driver: 'Luis Prado',
    route: 'Pinheiros -> Itaim',
    origin: 'Pinheiros',
    destination: 'Itaim Bibi',
    value: 29.8,
    status: 'Cancelada',
    duration: '6 min',
    requestedAt: 'ha 14 min',
    path: [[-23.5662, -46.7019], [-23.5695, -46.6872], [-23.5752, -46.6802]],
    driverPosition: [-23.5752, -46.6802],
    passengerPosition: [-23.5844, -46.6785],
  },
  {
    id: 'BRL-84208',
    passenger: 'Pedro Rocha',
    driver: 'Clara Alves',
    route: 'Vila Madalena -> Se',
    origin: 'Vila Madalena',
    destination: 'Se',
    value: 42.2,
    status: 'Concluida',
    duration: '31 min',
    requestedAt: 'ha 23 min',
    path: [[-23.5546, -46.6909], [-23.5565, -46.6702], [-23.5502, -46.6508], [-23.5504, -46.6339]],
    driverPosition: [-23.5504, -46.6339],
    passengerPosition: [-23.5504, -46.6339],
  },
  {
    id: 'BRL-84207',
    passenger: 'Luiza Martins',
    driver: 'Andre Mota',
    route: 'Tatuape -> Jardins',
    origin: 'Tatuape',
    destination: 'Jardins',
    value: 64.7,
    status: 'Em andamento',
    duration: '28 min',
    requestedAt: 'ha 31 min',
    path: [[-23.5409, -46.5766], [-23.5478, -46.6042], [-23.5583, -46.6354], [-23.5677, -46.6674]],
    driverPosition: [-23.5583, -46.6354],
    passengerPosition: [-23.5677, -46.6674],
  },
]
