...
export const recentApprovalHistory: ApprovalHistoryItem[] = [
  {
    ...
    reviewer: 'Admin',
    driver: {
      ...pendingApprovalDrivers[0],
      id: 'DRV-5098',
      name: 'Paula Rocha',
      initials: 'PR',
      cpf: '734.120.980-31',
      email: 'paula.rocha@email.com',
      birthDate: '19/02/1990',
      city: 'Santo Andre, SP',
      address: 'Rua das Figueiras, 412',
      neighborhood: 'Jardim',
      zipCode: '09080-300',
      phone: '(11) 97720-4418',
      ...
      bankAgency: '1432',
      bankAccount: '55218-6',
      emergencyContact: 'Felipe Rocha',
      emergencyPhone: '(11) 98440-1289',
      referralSource: 'Indicacao de passageiro',
      requestedAt: '04/05/2026 16:22',
      faceCheck: { score: 93.8, status: 'Aprovado' },
    },
  },
  {
    id: 'hist-5097',
    ...
    reviewer: 'Admin',
    reason: 'CNH vencida e selfie com divergencia facial.',
    driver: {
      ...
      initials: 'NF',
      cpf: '618.904.210-66',
      email: 'nicolas.freitas@email.com',
      birthDate: '08/07/1986',
      city: 'Osasco, SP',
      address: 'Avenida dos Autonomistas, 2100',
      neighborhood: 'Centro',
      zipCode: '06020-010',
      phone: '(11) 99672-8810',
      cnhExpiresAt: '12/03/2025',
      vehicle: 'Renault Logan 2020',
      vehicleYear: '2020',
      vehicleColor: 'Branco',
      plate: 'NFS-8C40',
      bankName: 'Caixa',
      bankAgency: '0924',
      bankAccount: '38120-1',
      emergencyContact: 'Bruna Freitas',
      emergencyPhone: '(11) 98874-3331',
      referralSource: 'Cadastro organico',
      requestedAt: '04/05/2026 13:05',
      faceCheck: { score: 62.5, status: 'Reprovado' },
    },
  },
]
